...
load_dotenv("/home/www/AgentFlow/CodeRAG/.env")

# === Environment Variables ===
# OpenAI API key and model settings (loaded from .env)
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")
OPENAI_EMBEDDING_MODEL = os.getenv("OPENAI_EMBEDDING_MODEL", "text-embedding-3-small")  # Default to ada-002
OPENAI_CHAT_MODEL = os.getenv("OPENAI_CHAT_MODEL", "gpt-4o")  # Default to GPT-4
...
FAISS_INDEX_FILE = os.getenv("FAISS_INDEX_FILE", os.path.join(WATCHED_DIR, 'faiss_index.bin'))
...
IGNORE_PATHS = [
    ...
    os.path.join(WATCHED_DIR, "grammars"),
]
